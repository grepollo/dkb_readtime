        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    @else
                        <div class="col-md-12">
                            <h4>You have incorrect answers, please try again.</h4>
                        </div>
                    @endif
                    <div class="row">
                        <div class="col-md-12">
                            <button class='btn stop-timer-btn hidden }}'>Stop</button>
                            <div class="questions {{ ! empty($incorrect) ? '' : 'hidden' }}">
                                {!! Form::open(array('url' => 'validate', 'method' => 'POST')) !!}
                                {!! Form::hidden('time', old('time'), ['id' => 'time']) !!}
                                {!! Form::hidden('words', old('words'), ['id' => 'words']) !!}
                                <ol>
                                    <li> Between annuity and lump sum, which has a larger total payout? <br/>
                                        @if(isset($incorrect['answer1']))
                                        <span style="color:red">Incorrect answer, please change.</span> <br/>
                                        @endif
